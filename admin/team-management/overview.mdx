...
**Owners** can transfer ownership to another team member from the [General](https://app.checklyhq.com/settings/account/general) section in account settings. Click "Transfer ownership" and follow the prompts. Your role will change to **Admin** after the transfer.
