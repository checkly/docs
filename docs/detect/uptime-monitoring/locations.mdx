...
<Note>
Private locations are available on Team and Enterprise plans. See [Private Locations documentation](/docs/detect/private-locations/overview) for setup details.
</Note>
