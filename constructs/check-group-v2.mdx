...
If you need these features, consider using the [Checkly import feature](/docs/cli/checkly-import/) to import the group. For example: `npx checkly import check-group:123` will import the targeted group. Alternatively, you can define a new group directly in your project.
