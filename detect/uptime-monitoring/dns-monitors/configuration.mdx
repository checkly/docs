...
* **DNS server:** By default, queries use 8.8.8.8 (Google DNS) with fallback to 1.1.1.1 (Cloudflare) and an internal AWS resolver. You can override this with a custom DNS server (domain + port or IP).
