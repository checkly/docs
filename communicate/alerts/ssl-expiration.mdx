...
set the day threshold to your preference. If you don't have your alert channels set up yet, see [Alert Channels](/alerting-and-retries/alert-channels/).
...
<Warning>
When using [environment variables in the URL](/api-checks/variables/#accessing-variables-in-api-checks), make sure that the domain is fully specified.
