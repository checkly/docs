...
<Frame>
  <img src="/images/guides/playwright-to-monitoring/test-session-passing.png" alt="A recorded test session in Checkly showing the search and checkout tests passing with their Playwright report" />
</Frame>
...
<Frame>
  <img src="/images/guides/playwright-to-monitoring/result-failing.png" alt="A failed Playwright Check Suite result in Checkly with the checkout test error, screenshot, and trace" />
</Frame>
