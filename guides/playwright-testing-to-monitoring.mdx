...
- You finished the [quickstart](/quickstart): a Checkly account and `npx checkly login` done.
- Node.js `20.19+` or `22.12+`.
- A repository with Playwright tests and a `playwright.config.ts`, Playwright 1.40 or newer.
...
```txt Prompt
Turn the Playwright tests in this repository into Checkly production monitors. Read `npx checkly skills configure playwright-check-suites` first.
...
- [Checkly Skills](/ai/skills) and [`npx checkly skills`](/cli/checkly-skills)
