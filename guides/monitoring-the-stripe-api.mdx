...
2. [Defining our API checks as code](/guides/structuring-a-checkly-project) to scale our setup while lowering maintenance needs.
...
<Card title="Monitoring as Code" href="/guides/structuring-a-checkly-project">
