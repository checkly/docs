...
If you have a single CLI project, we recommend defining your alert channels within that CLI project and referencing them as JS/TS objects, instead of using `fromId()`. This allows your alert channels to be managed as code with benefits like version control, alongside your other CLI resources.