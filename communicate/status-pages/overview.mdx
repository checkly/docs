...
### Connecting Checks to Service to automate Incident communication (paid plans)

Checks can also be associated with a Service, and create an automatically open incidents whenever it fails. [See incident automation for more details](/communicate/status-pages/incidents#incident-automation).
