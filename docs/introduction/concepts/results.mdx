...
![check results browser page navigation top](/images/docs/images/monitoring/check-results-browser-page-navigations-top.png)
...
![Using the Multistep check results view](/images/docs/images/monitoring/check-results-multistep.mp4)
