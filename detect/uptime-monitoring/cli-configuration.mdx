...
const { Frequency, UrlMonitor, UrlAssertionBuilder } = require('checkly/constructs')
...
import { Frequency, UrlMonitor, UrlAssertionBuilder, EmailAlertChannel, SlackAppAlertChannel } from 'checkly/constructs'
...
const { Frequency, UrlMonitor, UrlAssertionBuilder, EmailAlertChannel, SlackAppAlertChannel } = require('checkly/constructs')
...
import { Frequency, TcpMonitor } from 'checkly/constructs'
...
const { Frequency, TcpMonitor } = require('checkly/constructs')
...
import { Frequency, TcpMonitor, TcpAssertionBuilder } from 'checkly/constructs'
...
const { Frequency, TcpMonitor, TcpAssertionBuilder } = require('checkly/constructs')
...
import { Frequency, CheckGroupV2, UrlMonitor, EmailAlertChannel, SlackAppAlertChannel } from 'checkly/constructs'
...
const { Frequency, CheckGroupV2, UrlMonitor, EmailAlertChannel, SlackAppAlertChannel } = require('checkly/constructs')
...
new UrlMonitor(`${environment}-api-check`, {
  ...
  locations: environment === 'production'
    ...
    : ['us-east-1'],
  frequency: environment === 'production' ? Frequency.EVERY_2M : Frequency.EVERY_10M,
...
endpoints.forEach((endpoint, index) => {
  new UrlMonitor(`api-${endpoint.path.replace('/', '')}-check`, {
    ...
    activated: true,
    locations: ['us-east-1', 'eu-west-1'],
    frequency: endpoint.path === '/payments' ? Frequency.EVERY_1M : Frequency.EVERY_5M, // More frequent for critical endpoints
