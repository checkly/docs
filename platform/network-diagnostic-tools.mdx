...
While TCP dumps and traceroute help you react to failures, [ICMP monitors](/detect/uptime-monitoring/icmp-monitors/overview) let you proactively detect network issues by continuously pinging a host. They measure round-trip latency and packet loss over time, making them useful for:
