...
You can then [set the Cookie header](/detect/synthetic-monitoring/api-checks/configuration) while editing your check.

> You can set the header at group-level using [API check defaults](/platform/groups) to have it applied to every API check in the group.
