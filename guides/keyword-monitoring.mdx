...
tags: Playwright
canonical: 'https://www.checklyhq.com/docs/guides/keyword-monitoring/'
---
...
- Finally I’ll use the global notification settings, and get notified via email, slack, SMS and a via a webhook to [Rootly](/integrations/incident-management/rootly)
