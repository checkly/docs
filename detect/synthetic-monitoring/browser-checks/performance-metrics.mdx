...
canonical: 'https://www.checklyhq.com/docs/detect/synthetic-monitoring/browser-checks/performance-metrics/'
---
...
Running a Playwright Check Suite instead? See [Web Vitals for Playwright Check Suites](/detect/synthetic-monitoring/playwright-checks/performance-metrics), which reports Web Vitals per page visit and adds LCP and INP attribution.
</Callout>
