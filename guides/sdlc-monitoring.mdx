...
Checkly Traces is easy to implement even if you aren’t currently using OpenTelemetry, [check out our documentation](/resolve/traces/overview) on how to get started.
...
3. [Group or tag tests](/platform/groups) by criticality to have consistent cadence for high value services - this also makes it easier to see checks together in the web UI
