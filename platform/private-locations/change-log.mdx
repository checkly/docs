...
<Update label="December 2025" description="v6.2.0" tags={["Dependencies"]}>
  Ensured `devDependencies` are not installed in the agent image
</Update>

<Update label="December 2025" description="v6.1.7" tags={["Dev Image", "Playwright Check Suites", "Security"]}>
...
<Update label="November 2025" description="v6.1.6" tags={["Playwright Check Suites", "Environment Variables"]}>
...
<Update label="November 2025" description="v6.1.5" tags={["Playwright Check Suites", "Metrics"]}>
  Added Playwright test metrics to the check overview page, including **Test performance** and **Test statuses** graphs
</Update>

<Update label="October 2025" description="v6.1.4" tags={["Reporting"]}>
  Minor patches on reporting
</Update>

<Update label="August 2025" description="v6.1.3" tags={["Security", "Secret Scrubbing"]}>
  Improved and centralized secret scrubbing for more reliable removal of sensitive data
</Update>

<Update label="August 2025" description="v6.1.2" tags={["Security", "Secret Scrubbing"]}>
...
<Update label="July 2025" description="v6.1.1" tags={["Bug Fix", "Proxy"]}>
...
<Update label="July 2025" description="v6.1.0" tags={["Security", "Secret Detection"]}>
...
<Update label="June 2025" description="v6.0.7" tags={["Networking"]}>
