...
sidebarTitle: 'Importing From the UI TODO'
---
...
Once you have a fully CLI managed setup you are ready to leverage Monitoring as Code to improve your setup. Check our how to [dynamically creating monitors](/cli/including-checks), [combining MaC and Git](/cli/using-git), and how to [integrate Checkly in your CI/CD process](/docs/integrations/ci-cd/overview).
