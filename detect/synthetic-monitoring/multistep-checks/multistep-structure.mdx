...
**2. Define our headers:** In many cases, you will have to authenticate when requesting data by providing authorization headers. Use [environment variables](/browser-checks/variables/) to avoid having any confidential data in your test.
