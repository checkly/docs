...
<Warning>
When using environment variables in your requests (like `{{API_TOKEN}}`), make sure [they are properly configured in your project or check group settings](/introduction/concepts/variables).
</Warning>
