...
sidebarTitle: 'Status Page Service (deprecated)'
canonical: 'https://www.checklyhq.com/docs/constructs/status-page-service/'
---

<Warning>
**Deprecated.** Services belong to v2 status pages. On v3 pages, use [`StatusPageV3Component`](/constructs/status-page-v3-component) instead.
</Warning>
<Tip>
