...
learn_playwright:
  parent: "Basics"
canonical: 'https://www.checklyhq.com/docs/learn/playwright/multitab-flows/'
---
...
1. Official documentation on [Playwright's multi-tab scenarios](https://playwright.dev/docs/pages)
