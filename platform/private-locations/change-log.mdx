...
rss: true
canonical: 'https://www.checklyhq.com/docs/platform/private-locations/change-log/'
---
...
- Errors from browser, multistep and Playwright checks inside the agent are now reported to the private location's Errors tab
</Update>
...
- Playwright Check Suites: add support for <a href="/resolve/traces/overview/">Checkly Traces</a>
...
<Update label="v8.3.3" tags={["June 2026"]}>
- Fixed a bug that caused agent health and readiness probes to fail during graceful shutdown.
</Update>
...
- Fixed a bug that prevented users of pnpm workspaces to run their PWCS on private locations in certain scenarios.
