...
<Tip>
**Monitoring as Code**: Learn more about the [Maintenance Window Construct](/constructs/maintenance-window) or [API](/api/maintenance-windows).
</Tip>
...
![maintenance window editor](/images/docs/images/maintenance-windows/maintenance-window-editor.png)
