...
<Tip>
Learn more about Microsoft Teams alerts in [the Microsoft Teams Alerts documentation](/docs/integrations/alerts/msteams).
</Tip>
...
Find more information on how to set up a Microsoft Teams workflows in [the Microsoft Teams documentation](/docs/integrations/alerts/msteams).
