...
weight: 10
canonical: 'https://www.checklyhq.com/docs/learn/opentelemetry/getting-started-with-observability/'
---
...
- **Quick Start Guide**: A guide for setting up OpenTelemetry quickly to start monitoring your applications [here](https://opentelemetry.io/docs/getting-started/).
