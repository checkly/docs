...
weight: 55
canonical: 'https://www.checklyhq.com/docs/learn/monitoring/synthetic-monitoring/'
---
...
### Keyword Monitoring
Keyword monitoring entails monitoring for content that is expected to appear in an API response or within a UI. [Keyword monitoring](/guides/monitoring-ecommerce-apps-using-playwright) can be extremely helpful for commerce sites or other content-driven websites like news publishers and blogs.
