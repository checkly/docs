...
description: 'View your Checkly account plan, entitlements, feature limits, and available locations.'
sidebarTitle: 'checkly account'
canonical: 'https://www.checklyhq.com/docs/cli/checkly-account/'
---
...
- [`checkly members`](/cli/checkly-members) - List and manage account members
