...
Once you have a fully CLI managed setup you are ready to leverage Monitoring as Code to improve your setup. Check our how to [dynamically creating monitors](/cli/including-checks) and how to [integrate Checkly in your CI/CD process](/docs/integrations/ci-cd/overview).
