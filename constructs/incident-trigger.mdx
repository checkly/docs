...
sidebarTitle: 'Incident Trigger (deprecated)'
canonical: 'https://www.checklyhq.com/docs/constructs/incident-trigger/'
---

<Warning>
**Deprecated.** Incident triggers automate incidents on v2 (services-based) status pages. On v3 pages, use [`StatusPageV3AutomationRule`](/constructs/status-page-v3-automation-rule) instead.
</Warning>
<Tip>
