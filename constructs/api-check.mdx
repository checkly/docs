...
<Tip>Learn more about writing setup and teardown scripts in [the setup and teardown scripts documentation](/docs/detect/synthetic-monitoring/api-checks/set-up-and-tear-down).</Tip>
...
<Warning>
When using environment variables in your requests (like `{{API_TOKEN}}`), make sure [they are properly configured in your project or check group settings](/docs/introduction/concepts/variables).
</Warning>
