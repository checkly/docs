...
tags: API Monitoring
canonical: 'https://www.checklyhq.com/docs/guides/monitoring-an-openapi-spec/'
---
...
2. Defining our [API checks as code](/guides/startup-guide-detect-communicate-resolve) to scale our setup.
