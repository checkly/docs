...
[Windsurf / Devin Desktop](https://docs.devin.ai/desktop/cascade/mcp) is not currently supported for Checkly MCP OAuth. It supports remote MCP servers with OAuth, but Checkly does not currently have a supported CIMD or pre-registered static OAuth setup for Windsurf / Devin Desktop.

We can support Windsurf / Devin Desktop once it supports CIMD or pre-registered static OAuth clients for custom MCP servers.
...
We can support Devin CLI once CIMD support or a Checkly-provided static OAuth setup is available.
