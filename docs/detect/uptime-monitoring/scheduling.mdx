...
<CardGroup cols={3}>
<Card title="URL Monitors" icon="globe">
Every 10 seconds to 24 hours based on service criticality
</Card>

<Card title="TCP Monitors" icon="network-wired">
Every 30 seconds to 60 minutes for infrastructure monitoring
</Card>

<Card title="Heartbeat Monitors" icon="heart">
Period-based scheduling matching job execution frequency
</Card>
</CardGroup>
