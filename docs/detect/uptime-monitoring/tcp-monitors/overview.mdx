...
Configure alerts for various failure conditions. See [alerting configuration](/docs/detect/uptime-monitoring/alerting) for comprehensive setup guidance:
...
Manage TCP monitors as code with the Checkly CLI
</Card>
</CardGroup>