...
<Update label="v6.1.7" tags={["December 2025"]}>
  - Added support for a [dev image](https://www.checklyhq.com/docs/platform/private-locations/dev-agent/), which is published both as a floating tag `checkly/agent:dev` and as a versioned image `checkly/agent:X.Y.Z-dev`
