...
sidebarTitle: 'checkly pw-test ALMOST'
---
...
Create a [Checkly Check Suite](/docs/detect/synthetic-monitoring/playwright-checks/overview) from your defined Playwright test suite. This will automatically convert your test into a monitoring check that runs on Checkly's infrastructure.
...
You can find more detailed example below in the [Creating Scheduled Checks](#creating-scheduled-checks) section.
