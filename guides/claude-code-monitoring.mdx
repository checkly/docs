...
* Checks with a matching logical ID from a previous deployment are listed under "Update", with a diff of what changed, or only counted under "Unchanged" when nothing did.
