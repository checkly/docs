...
Environment variables to be passed to the check run. Multiple values can be passed and passed variables overwrite any existing variables stored in your Checkly account.
