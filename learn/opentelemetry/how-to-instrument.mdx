...
canonical: 'https://www.checklyhq.com/docs/learn/opentelemetry/how-to-instrument/'
---
...
For more on how to add instrumentation to specifically integrate with Checkly Traces, [see our Traces documentation](/resolve/traces/overview).
