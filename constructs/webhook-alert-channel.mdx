...
<Tip>
Learn more about Webhook alerts in [the webhook alert documentation](/docs/integrations/alerts/webhooks).
</Tip>
...
Learn more about using environment and predefined variables in your webhook template in [the webhook documentation](/docs/integrations/alerts/webhooks#template-variables).
