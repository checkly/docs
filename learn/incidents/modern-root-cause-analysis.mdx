...
canonical: 'https://www.checklyhq.com/docs/learn/incidents/modern-root-cause-analysis/'
---
...
![The Checkly dashboard packs in check frequency, retries, response times, and geographic distribution in one dashboard](/images/learn/images/modern-rca-01.png)
...
![Amazon CloudWatch Logs](/images/learn/images/modern-rca-02.png)
...
![Close Up Photos of Sand Grains By Siim Sepp (Sandatlas) - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=22300680](/images/learn/images/modern-rca-03.png)
...
*Want to improve your RCA? Start by connecting your [OpenTelemetry tracing to Checkly](/resolve/traces/overview)—before the next outage hits.*