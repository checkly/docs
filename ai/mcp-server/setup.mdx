...
<Warning>
The Checkly MCP Server only supports MCP clients that use OAuth Client ID Metadata Documents (CIMD). Clients that only support Dynamic Client Registration (DCR) cannot connect.
</Warning>
