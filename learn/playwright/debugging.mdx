...
learn_playwright:
  parent: "Debugging"
canonical: 'https://www.checklyhq.com/docs/learn/playwright/debugging/'
---
...
If we are using Playwright, we can also run in debug mode with `PWDEBUG=console node script.js`. This provisions a `playwright` object in the browser which allows us to also try out [Playwright-specific selectors](https://playwright.dev/docs/locators).
