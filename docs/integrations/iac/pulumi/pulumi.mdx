---
title: 'Integrating Pulumi with Checkly'
description: 'Use the Checkly Pulumi provider to declare your monitoring setup as code and manage checks with infrastructure as code'
sidebarTitle: 'Pulumi'
---
