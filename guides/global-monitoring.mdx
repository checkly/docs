...
<Frame>
  <img src="/images/guides/global-monitoring/where-requests-break.svg" alt="Diagram of the six hops from a user's device to application code, with examples of failures that affect only one region at each hop, and who notices them first" />
</Frame>
