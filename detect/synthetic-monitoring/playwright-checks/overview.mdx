...
**A Playwright **Check** Suite is a collection of tests that are defined in one or more `spec.ts` files.** To control which tests become part of your Playrwight Check Suite use:
