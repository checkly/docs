...
If you need these features, you can either import the group using the [Checkly import feature](/docs/cli/checkly-import/) (e.g. npx checkly import check-group:123) or define a new group directly in your project.
