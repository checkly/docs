...
3. Generate a golden image / reference snapshot by clicking the "Run script and update golden image" option in the "run script" button.
   ...
   ![generate reference snapshot](/images/docs/images/browser-checks/visual_comparison_1st_run.mp4)
...
![inspect visual diff](/images/docs/images/browser-checks/visual_comparison_diff_modal.mp4)
...
<Cards>
<Card title="GitHub Actions" href="/docs/integrations/ci-cd/github/actions" icon="github" />
<Card title="GitLab CI/CD" href="/docs/integrations/ci-cd/gitlab" icon="gitlab" />
<Card title="Jenkins" href="/docs/integrations/ci-cd/jenkins" icon="jenkins" />
<Card title="Vercel" href="/docs/integrations/ci-cd/vercel" icon="vercel" />
</Cards>
