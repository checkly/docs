...
canonical: 'https://www.checklyhq.com/docs/detect/uptime-monitoring/overview/'
---
...
<Columns cols={1}>
    ...
    <Card title="gRPC Monitors" href="/detect/uptime-monitoring/grpc-monitors/overview" horizontal>
    Monitor gRPC service availability, health, and response correctness.
