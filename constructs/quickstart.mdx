...
<Note>Use this guide to manually set up your Checkly configuration. [Follow the quickstart guide](/introduction/quickstart) and `npm create checkly` for an automatic setup.</Note>
