...
learn_playwright:
  parent: "Debugging"
canonical: 'https://www.checklyhq.com/docs/learn/playwright/error-target-closed/'
---
...
Our script can return the sometimes cryptic "Target closed" error. Knowing that the "target" is normally our browser, the [context](https://playwright.dev/docs/browser-contexts) or tab that our script is controlling can help us close in on the cause of the issue.
