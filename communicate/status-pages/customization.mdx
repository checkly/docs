...
<Step title="Verify you are the owner of the domain by adding a `TXT` record to your DNS">
The record can be copied from the Status Page configuration page after providing a custom domain and saving the page once.
