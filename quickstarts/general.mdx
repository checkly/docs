...
From here, the agent generates checks from your project, logs in, runs them with `npx checkly test`, and deploys them with `npx checkly deploy`, asking for input when it needs it. Open [your Checkly dashboard](https://app.checklyhq.com) to see your monitoring live.
