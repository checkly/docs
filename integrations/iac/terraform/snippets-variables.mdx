...
[Code snippets](/browser-checks/partials-code-snippets/) allow you to reuse code across multiple checks without duplication. They work with [setup & teardown scripts](/api-checks/setup-teardown-scripts/#reusable-code-snippets) in API checks and [browser checks](/browser-checks/partials-code-snippets/).
