...
learn_playwright:
  parent: "E2E examples"
canonical: 'https://www.checklyhq.com/docs/learn/playwright/testing-coupons/'
---
...
2. Assertion libraries are useful when non-trivial [assertions](/detect/synthetic-monitoring/api-checks/configuration) are required.
