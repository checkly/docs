...
![Navigate to create browser check](/images/docs/images/browser-checks/create-browser-check-nav.png)
...
![Browser check script editor](/images/docs/images/browser-checks/browser-check-script.png)
</Step>
...
![Browser check assertions](/images/docs/images/browser-checks/browser-check-assertions.png)
</Step>
...
![Browser check monitoring configuration](/images/docs/images/browser-checks/browser-check-monitoring.png)
</Step>
...
![Browser check alerting setup](/images/docs/images/browser-checks/browser-check-alerts.png)
</Step>
...
![Browser check test results](/images/docs/images/browser-checks/browser-check-test.png)
</Step>
...
![Browser check dashboard results](/images/docs/images/browser-checks/browser-check-dashboard.png)
</Step>
</Steps>
