...
```bash
curl -H "Accept: text/markdown" https://www.checklyhq.com/docs/what-is-checkly.md
```
...
Every documentation page includes a **Copy as Markdown** button in the top of the page sidebar. Click it to copy the full page content as markdown to your clipboard.
