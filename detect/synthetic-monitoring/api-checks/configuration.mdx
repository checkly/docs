...
canonical: 'https://www.checklyhq.com/docs/detect/synthetic-monitoring/api-checks/configuration/'
---
...
Checkly displays a preview and download option in API check results when the raw response body is 50KB (50,000
bytes) or smaller and the response `Content-Type` is one of these supported raster image types:
