...
Record test results in Checkly as [a test session](/docs/detect/testing/overview) with full logs, traces and videos.
...
<Note>Snapshots are essential for [visual regression testing in Browser Checks](/docs/detect/synthetic-monitoring/browser-checks/visual-regressions).</Note>
