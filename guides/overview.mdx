...
mode: 'wide'
canonical: 'https://www.checklyhq.com/docs/guides/overview/'
---
...
<Columns cols={3}>
<Card title="Structure a project" icon="folder-tree" href="/guides/structuring-a-checkly-project">
Organize checks by service with groups, share settings in one config, and deploy from CI on every merge
</Card>

<Card title="Playwright tests to monitors" icon="theater-masks" href="/guides/playwright-testing-to-monitoring">
Run the Playwright tests you already have as scheduled production monitors, and see what a failure looks like
</Card>
</Columns>
...
<Card title="Monitor from around the globe" icon="globe" href="/guides/global-monitoring">
Why one vantage point is not monitoring, with real per-location latency data, parallel scheduling, and region-consensus alerts
</Card>

<Card title="Alert without the noise" icon="bell" href="/guides/alerting">
Route alerts by urgency, retry blips in place, escalate on consecutive runs, and mute planned deploys
</Card>
...
<Card title="Monitor a checkout flow" icon="shopping-cart" href="/guides/monitoring-ecommerce-apps-using-playwright">
Browse, search, add to cart, and checkout as one Playwright Check Suite, with a confirmation-text assertion and a Terraform equivalent
</Card>
...
<Card title="Run checks on every deploy" icon="diagram-project" href="/guides/sdlc-monitoring">
Test pull request previews and validate production deployments with recorded Checkly sessions
</Card>
</Columns>
