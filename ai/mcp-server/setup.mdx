...
<Note>
The Checkly MCP Server supports the `2026-07-28` and `2025-06-18` protocol versions on the same endpoint. Your MCP client negotiates the version automatically, so existing client configurations do not need to change.
</Note>
