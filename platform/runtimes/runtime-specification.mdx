...
- [24.x](https://nodejs.org/dist/latest-v24.x/docs/api/)
- [22.x](https://nodejs.org/dist/latest-v22.x/docs/api/)
...
This runtime includes Playwright v1.58.2 and Node.js v24.13.1. New dependencies are: `axios-cookiejar-support`, `csv-parse`, `imapflow`, `mysql2`, `pdf-parse`, `tough-cookie` and `winston`. `jsdom` has been removed — you can use Playwright's built-in page APIs instead.
