...
This guide will walk you through creating your first Browser Check with Checkly. Browser Checks are perfect for monitoring realistic user flows within your application or services. If you are looking for monitoring of general availability, check out the [Uptime Monitor Quickstart](/docs/detect/uptime-monitoring/creating-a-your-first-url-monitor).
