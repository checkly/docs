...
canonical: 'https://www.checklyhq.com/docs/platform/runtimes/overview/'
---
...
1. We bundle all your user code when using the [Checkly CLI](/cli/overview) or GitHub Sync before storing your Check in our database.
