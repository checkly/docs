...
![Trace with missing spans](images/images/docs/images/otel/traces-missing-spans.png)
...
### Checkly Private Location setup
   When setting up Traces with a [Checkly Private Location](/docs/detect/private-locations/overview#configuring-a-private-location):
