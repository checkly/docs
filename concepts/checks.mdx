...
2. If the check is an API check and has a [setup script](/detect/synthetic-monitoring/api-checks/set-up-and-tear-down), the setup script is executed. 
3. The check is executed.
4. If the check is an API check and has a [teardown script](/detect/synthetic-monitoring/api-checks/set-up-and-tear-down), the teardown script is executed.
