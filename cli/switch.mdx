...
- [`--verbose`](/cli-reference/global-options#verbose-or-v) - Show detailed account information during selection
...
- [`checkly whoami`](/cli-reference/whoami) - Display current active account
