...
sidebarTitle: 'Status Page (deprecated)'
canonical: 'https://www.checklyhq.com/docs/constructs/status-page/'
---

<Warning>
**Deprecated.** This construct creates a v2 (cards and services) status page. New status pages should use [`StatusPageV3`](/constructs/status-page-v3). Existing v2 pages keep working and can be migrated to v3 with the migration wizard in the Checkly app.
</Warning>
<Tip>
