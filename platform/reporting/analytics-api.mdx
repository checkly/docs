...
Dive straight into the [API reference](/api-reference/analytics/api-checks) or keep reading for more examples!
...
setting the required HTTP header and query parameters to fetch the JSON. You'll find detailed docs on available parameters in the [API docs](/api-reference/analytics/api-checks)
