...
The Prometheus exporter also contains metrics for monitoring [Private Locations](/detect/private-locations/overview). These metrics can be used to ensure that your Private Locations have enough Checkly Agent instances running to execute all of your checks.
