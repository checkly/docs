...
<Info>
**Runtime Environment**: Playwright Check Suites run in a slim Node.js runtime with only your custom dependencies. See the [runtime specification](/platform/runtimes/runtime-specification) for further details.
</Info>
