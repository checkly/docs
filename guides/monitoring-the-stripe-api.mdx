...
![jamstack architecture diagram](/guides/images/guides-checkly-jamstack-header.png "Jamstack applications heavily rely on APIs")
...
![swagger api documentation](/guides/images/guides-checkly-swagger.png "Swagger is a popular tool for generating API documentation")
...
![checkly dashboard with API checks](/guides/images/guides-checkly-dashboard-short.png "Checkly API checks shown on a dashboard")
...
![checkly check creation process](/guides/images/guides-checkly-stripe-check.png "Checkly API check creation")
...
![setting up assertions in an api check](/guides/images/guides-checkly-assertions.png "Setting up assertions for our check")
...
![setting up response time limits in an api check](/guides/images/guides-checkly-response-limits.png "Choosing response time limits")
...
![programmable setup scripts](/guides/images/guides-checkly-setup.png "Setup and teardown methods are fully scriptable using NodeJS")
