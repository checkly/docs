...
canonical: 'https://www.checklyhq.com/docs/guides/structuring-a-checkly-project/'
---
...
```txt Prompt
Restructure the Checkly project in this repository so it scales with the codebase. Read `npx checkly skills configure` and `npx checkly skills configure check-groups` first.
