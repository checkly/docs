...
description: How the Checkly CLI attaches git metadata to test sessions and deployed checks so you can trace results back to specific commits and branches.
