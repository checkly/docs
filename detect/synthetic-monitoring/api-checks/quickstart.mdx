...
canonical: 'https://www.checklyhq.com/docs/detect/synthetic-monitoring/api-checks/quickstart/'
---
...
The [Checkly CLI](/cli/overview) gives you a JavaScript/TypeScript-native workflow for coding, testing and deploying synthetic monitoring at scale, from your code base.
