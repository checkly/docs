...
<Note>Use this guide to manually set up your Checkly configuration. [Follow the quickstart guide](quickstart/browser-check/) and `npm create checkly` for an automatic setup.</Note>
