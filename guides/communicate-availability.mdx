...
canonical: 'https://www.checklyhq.com/docs/guides/communicate-availability/'
---
...
Checkly's [Monitoring as Code](/guides/startup-guide-detect-communicate-resolve) approach enables you to automate the entire flow of creating status pages, connecting services, and configuring checks.
