...
To learn more about the results shown for each check type, refer to the documentation for the specific monitor (URL, TCP, Browser, Playwright Check Suite etc.) under [Detect](/detect/overview).
