...
<Tip>
Learn more about Slack alerts in [the Slack Alerts documentation](/docs/integrations/alerts/slack).
</Tip>
...
Find more information on how to set up a new Slack webhook in [the Slack alert channel documentation](/docs/integrations/alerts/slack).
