...
tags:
  - FAQ
canonical: 'https://www.checklyhq.com/docs/guides/create-multiple-monitors/'
---
...
Deploy preview · URL Monitors → account Monitoring as Code

  + UrlMonitor  multi-url-monitor-0checklyhq.com  __checks__/urlArrayMonitors.check.ts
  + UrlMonitor  multi-url-monitor-1checklyhq.com  __checks__/urlArrayMonitors.check.ts
  + UrlMonitor  multi-url-monitor-2checklyhq.com  __checks__/urlArrayMonitors.check.ts
  + UrlMonitor  multi-url-monitor-3checklyhq.com  __checks__/urlArrayMonitors.check.ts
  + UrlMonitor  multi-url-monitor-4checklyhq.com  __checks__/urlArrayMonitors.check.ts

5 to create, 0 unchanged
...
import { Frequency, CheckGroupV2, RetryStrategyBuilder } from 'checkly/constructs'
...
new UrlMonitor('url-monitor-example', { 
  ...
  //response time thresholds are always set per monitor
  maxResponseTime: 10000,
  request: {
