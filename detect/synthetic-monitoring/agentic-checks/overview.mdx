...
canonical: 'https://www.checklyhq.com/docs/detect/synthetic-monitoring/agentic-checks/overview/'
hidden: true
---
...
Existing accounts can continue using their active and deactivated Agentic Checks. Deactivated checks retain their configuration and history.
