...
description: 'Configure Agentic Checks with prompts, variables, skills, scheduling, and locations.'
sidebarTitle: 'Configuration'
canonical: 'https://www.checklyhq.com/docs/detect/synthetic-monitoring/agentic-checks/configuration/'
hidden: true
---
