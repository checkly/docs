...
The public MCP Server only supports OAuth clients that use Client ID Metadata Documents (CIMD). Checkly rejects clients that attempt to use Dynamic Client Registration (DCR).
