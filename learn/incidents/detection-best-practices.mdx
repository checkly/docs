...
learn_incidents:
  parent: Detection
canonical: 'https://www.checklyhq.com/docs/learn/incidents/detection-best-practices/'
---
...
- **Check External Endpoints**: Regularly test third-party services. With [Checkly’s API monitors](/detect/synthetic-monitoring/api-checks/overview), you can send frequent quick checks to external API’s you rely on, and get reliable notifications if something isn’t working, before users report a problem.
...
- **Monitor DNS & CDN Health**: Use tools like Checkly to [detect regional outages](/concepts/locations).
