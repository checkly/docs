...
weight: 10
canonical: 'https://www.checklyhq.com/docs/learn/monitoring/intro-to-sdlc/'
---
...
You can [run the same checks against pull request previews and production deployments](/guides/sdlc-monitoring).
