...
You can invite team members to join your Checkly account to view and manage all checks and related settings; team members can have different [roles](/docs/introduction/platform/admin/overview).
