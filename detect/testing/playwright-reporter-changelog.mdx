...
<Update label="v1.1.0" tags={["January 2026"]}>
  > **Note:** This minor version contains breaking changes. Due to options API configurations in 1.0.x that could lead to broken states, we decided to publish this as a minor version and unpublish previous 1.0.x releases to prevent issues.
...
<Update label="v1.0.2" tags={["January 2026"]}>
  - Added anonymous telemetry to understand reporter usage patterns. Disable with `telemetry: false` option
