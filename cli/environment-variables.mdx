...
[Global, Group or Check level](/docs/detect/synthetic-monitoring/browser-checks/overview). Here is what you need to remember:
...
[See the reference documentation for the `checkly env` command](/cli/checkly-env)
...
3. For remote variables, store sensitive data as secrets in Checkly. For more information on how to manage secrets in Checkly see [variables and secrets](/docs/detect/synthetic-monitoring/browser-checks/overview).
