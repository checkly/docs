...
When inviting a team member to join your account you can assign one of five roles that all have different access patterns.
...
4. **Read & Run**
    ...
    - Can manually trigger checks and tests via the UI, CLI, and API.
