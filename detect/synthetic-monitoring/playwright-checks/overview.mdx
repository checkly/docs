...
Choose which tests to monitor using Playwright projects or tags from your existing configuration.
</Step>
<Step title="3. Choose frequency and locations">
Specify the locations the synthetic check executes from, and set the check frequency.

</Step>
<Step title="2. Deploy globally">
Run selected tests on schedules from multiple worldwide locations with performance tracking and detailed reporting.
</Step>

<Step title="3. Get alerted">
...
- **testCommand**: Use `npx playwright test ...` to do the right slicing.
