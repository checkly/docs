...
<CardGroup cols={2}>
<Card title="Creating Your First Browser Check" href="/docs/detect/synthetic-monitoring/browser-checks/creating-a-browser-check">
Step-by-step guide to set up browser monitoring
</Card>

<Card title="Browser Check Examples" href="/docs/detect/synthetic-monitoring/browser-checks/examples">
