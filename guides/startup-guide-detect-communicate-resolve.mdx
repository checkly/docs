...
![a checkly dashboard](/images/docs/guides/images/startup-tutorial-00.png)
...
![the codegen playwright inspector](/images/docs/guides/images/startup-tutorial-01.png)
...
![a Checkly dashboard](/images/docs/guides/images/startup-tutorial-02.png)
...
![The detail view when an API check fails](/images/docs/guides/images/startup-tutorial-03.png)
...
![When your browser check fails, Checkly stores a Playwright trace to offer in-depth, moment-by-moment reviews of what the browser saw as it tried to load the page.](/images/docs/guides/images/startup-tutorial-04.png)
...
![When your browser check fails, Checkly stores a Playwright trace to offer in-depth, moment-by-moment reviews of what the browser saw as it tried to load the page.](/images/docs/guides/images/startup-tutorial-05.png)
