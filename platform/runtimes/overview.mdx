...
Checkly allows you to use JavaScript code in your [Browser checks](/docs/detect/synthetic-monitoring/browser-checks/overview), [MultiStep Checks](/docs/detect/synthetic-monitoring/multistep-checks/overview) and in the optional [setup & teardown scripts](/docs/detect/synthetic-monitoring/api-checks/set-up-and-tear-down) you can add to your API checks.
