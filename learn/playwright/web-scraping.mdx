...
canonical: 'https://www.checklyhq.com/docs/learn/playwright/web-scraping/'
---
...
## Further reading
1. [Playwright](https://playwright.dev/docs/test-assertions)'s official API reference on the topic
