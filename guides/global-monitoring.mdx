...
<Frame>
  <img src="/images/guides/global-monitoring/round-trips.svg" alt="Chart of time to first byte from Ohio, Frankfurt, São Paulo, Mumbai and Sydney to an origin in Virginia, broken into DNS, TCP, TLS and HTTP round trips, ranging from about 60 milliseconds to about 800" />
</Frame>
