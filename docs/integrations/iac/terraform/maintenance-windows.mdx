...
[Maintenance windows](/docs/communicate/maintenance-windows/overview) allow you to schedule planned maintenance periods to prevent your checks from running and generating false alerts during known downtime periods.
...
- [Maintenance windows documentation](/docs/communicate/maintenance-windows/overview)
- [Tag-based filtering strategies](/docs/communicate/dashboards/overview#adding-checks-to-your-dashboard)