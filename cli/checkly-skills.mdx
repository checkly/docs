...
canonical: 'https://www.checklyhq.com/docs/cli/checkly-skills/'
---
...
<Warning>`checkly rules` is deprecated and only prints a migration message. Use `checkly skills` instead.</Warning>
