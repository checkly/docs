...
canonical: 'https://www.checklyhq.com/docs/communicate/alerts/overview/'
---
...
When adding an alert channel, you can select which checks to subscribe to the channel. This way you can create specific routings
for specific checks.
