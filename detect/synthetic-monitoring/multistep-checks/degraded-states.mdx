...
description: How to use Checkly's degraded check state and soft assertions to flag non-critical errors and slow performance without triggering a failure.
