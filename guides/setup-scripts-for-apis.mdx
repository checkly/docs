...
> Like for [Browser checks](/browser-checks/), which libraries and modules are available in setup and teardown scripts depends on which [Runtime](/runtimes/) you have chosen. You can find a list of exactly [which libraries are included](/runtimes/specs/) in which runtime.
