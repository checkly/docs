...
<CardGroup cols={2}>
  <Card
    ...
    icon="/learn/icons/playwright-logo.svg"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="/learn/icons/best-practices.svg"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="/learn/icons/session-management.svg"
  ...
  <Card
    ...
    icon="/learn/icons/performance.svg"
