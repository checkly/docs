...
and a set of [3rd party libraries available in each runtime](/platform/runtimes/runtime-specification). Popular use cases are signing HMAC requests, 
...
[setup script examples](/detect/synthetic-monitoring/api-checks/examples) for actual examples of OAuth2, HMAC signing, JWT tokens 
...
Check out [our runtimes documentation](/platform/runtimes/runtime-specification) for a full specification of which modules are included.
...
To learn more about setup scripts, [check our setup script examples](/detect/synthetic-monitoring/api-checks/examples).
