...
[Learn more about adding team members](/introduction/platform/admin/adding-team-members)
...
[Learn about changing your email or password](/introduction/platform/admin/changing-your-email-password)
...
[Set up multi-factor authentication](/introduction/platform/admin/multi-factor-authentication)

### Single Sign-On (SSO)

For enterprise customers, Checkly supports SSO integration with your existing identity provider.

[Learn about SSO options](/introduction/platform/admin/single-sign-on)

**Available SSO Protocols:**
- [SAML](/introduction/platform/admin/saml) - Generic SAML 2.0 integration
- [Microsoft Azure AD](/introduction/platform/admin/microsoft-azure-ad) - Direct Azure AD integration
...
[Learn about creating and managing API keys](/introduction/platform/admin/creating-api-key)
