...
<Step title="Add a CNAME record that points to `custom-slug.checkly-status-page.com`">
...
<Step title="Add or update TXT record(s) to perform validation and prove domain ownership">
After you've added your custom domain and saved the page, one or two TXT records will be displayed depending on the domain you're using. 
...
<Note>
Search engines like Google require your TXT records to be up-to-date to enable their own verification and list your Status Page.
</Note>
</Step>
</Steps>
