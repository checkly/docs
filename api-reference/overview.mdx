...
<Note>
  We recommend using the [Checkly CLI](/cli/overview) or another [Monitoring as Code](/learn/monitoring/monitoring-as-code/) option, like [Terraform](/integrations/iac/terraform/overview), for creating and updating resources. This is doable using the Checkly API, but Monitoring as Code generally provides a better experience.
</Note>
