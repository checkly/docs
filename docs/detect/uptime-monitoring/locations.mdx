...
<Note>
Private locations are available on Team and Enterprise plans. See [Private Locations documentation](/docs/private-locations/) for setup details.
</Note>
...
<Card title="Private Locations" href="/docs/private-locations/">
Deploy monitoring agents in your own infrastructure
</Card>

<Card title="Global Locations" href="/docs/monitoring/global-locations">
