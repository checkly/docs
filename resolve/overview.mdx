...
<Card title="Traces" href="/resolve/traces/overview" icon="route" horizontal>
Analyze request flows with distributed tracing to identify performance bottlenecks and failures
</Card>

<Card title="Rocky AI" href="/resolve/error-analysis/overview" icon="robot" horizontal>
...
<Card title="Try Rocky AI" href="/resolve/error-analysis/overview">
