...
canonical: 'https://www.checklyhq.com/docs/integrations/ci-cd/overview/'
---
...
The preferred and most flexible way to integrate Checkly with your CI/CD is through the [Checkly CLI](/cli/overview).
