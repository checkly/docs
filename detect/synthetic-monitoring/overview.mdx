...
canonical: 'https://www.checklyhq.com/docs/detect/synthetic-monitoring/overview/'
---
...
Checkly provides four check types to comprehensively monitor your applications:
...
<Note>
Synthetic monitoring provides the most comprehensive validation when you combine the check types that fit your application. Start with the most critical user workflows and expand your coverage over time.
</Note>
