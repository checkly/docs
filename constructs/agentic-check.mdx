...
canonical: 'https://www.checklyhq.com/docs/constructs/agentic-check/'
hidden: true
---
...
Deactivating an Agentic Check preserves its configuration and history. Existing active and deactivated Agentic Checks remain usable for accounts that previously used this capability.
