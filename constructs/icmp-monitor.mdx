...
ICMP request configuration that defines the ICMP Echo Request to perform and how to validate the response.
...
| `assertions` | `IcmpAssertion[]` | ❌ | `[]` | Response assertions using `IcmpAssertionBuilder` |
