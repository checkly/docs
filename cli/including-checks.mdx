---
title: 'Including Checks'
description: 'Learn how to include checks in your project'
sidebarTitle: 'Including Checks TODO'
---
...
The `testMatch` property for Multistep checks work the same as for [Browser checks described above](#browsercheckstestmatch).
