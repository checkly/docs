...
The preferred and most flexible way to integrate Checkly with your CI/CD is through the [Checkly CLI](/docs/cli).
...
- [Vercel](/docs/integrations/ci-cd/vercel/overview)
- [GitHub deployments](/docs/integrations/ci-cd/github/deployments)
