...
<Warning>
This page describes the v1 version of the Prometheus exporter. If you are just starting with our Prometheus integration,  we recommend using our [v2 version](/docs/integrations/prometheus-v2/).
</Warning>
