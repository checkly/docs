...
<Note>
These proxy settings apply to agent management traffic to Checkly's API. For check-specific proxy configuration, see the [Proxy Setup guide](/docs/detect/private-locations/proxy-setup).
</Note>
</Accordion>
...
<Card title="Proxy Configuration" href="/docs/detect/private-locations/proxy-setup">
