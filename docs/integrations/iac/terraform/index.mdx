...
<Tip>
Looking for Monitoring as Code but don't want to use Terraform? Give our [CLI solution](/cli/overview) a try.
</Tip>
...
<CardGroup cols={2}>
<Card title="Alerting" icon="bell" href="/docs/integrations/iac/terraform/alerting">
Learn how to set up comprehensive alerting and notification channels
</Card>

<Card title="Check Groups" icon="layer-group" href="/docs/integrations/iac/terraform/checks-groups">
Organize your checks using groups for better management and shared configurations
</Card>

<Card title="CI/CD Integration" icon="git-merge" href="/docs/integrations/iac/terraform/ci-cd">
Integrate Terraform with your CI/CD pipelines for automated deployments
</Card>

<Card title="Troubleshooting" icon="wrench" href="/docs/integrations/iac/terraform/troubleshooting">
