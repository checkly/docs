...
2. Assertion libraries are useful when non-trivial [assertions](/detect/synthetic-monitoring/api-checks/assertions#json-responses-with-json-path) are required.
