...
<Info>
  **The Playwright Reporter is currently in a public beta**. [Contact the Checkly team](https://app.checklyhq.com/?support=true) for support or feedback. Expect breaking changes, features in development, and possible bugs.
</Info>
