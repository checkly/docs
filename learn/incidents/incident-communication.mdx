...
canonical: 'https://www.checklyhq.com/docs/learn/incidents/incident-communication/'
---
...
- Output the results of these checks to a publicly available [status page](/communicate/status-pages/overview)
