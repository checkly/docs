...
<Frame>
  <img src="/images/guides/global-monitoring/choosing-locations.png" alt="Three panels: pick locations where your users are, where your infrastructure runs, and one control location far from both; plus a strip on private locations for networks the internet cannot reach" />
</Frame>
