...
| `ALERT_TYPE`        | Type of alert, e.g. "ALERT_FAILURE", "ALERT_RECOVERY", "ALERT_DEGRADED", "ALERT_DEGRADED_RECOVERY". See [alert states](/alerting-and-retries/alert-states/#alert-states--transitions) for all options. |
...
![pagerduty incident headers](/images/alerting/webhook-pagerduty-headers.png)
