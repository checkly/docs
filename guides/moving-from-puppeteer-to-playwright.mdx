...
> **UPDATE**: _you can use our [puppeteer-to-playwright](https://github.com/checkly/puppeteer-to-playwright) conversion script to quickly migrate your Puppeteer codebase to Playwright._
...
> Did we forget anything? Please let us know by getting in touch, or [submit your own PR](https://github.com/checkly/checklyhq.com).
