...
description: How to work with files in Checkly browser checks, including testing file downloads and uploads using Playwright's download event and setInputFiles.
