...
* The query is sent to a DNS resolver. By default, it uses 8.8.8.8 (Google DNS). If that fails, it falls back to 1.1.1.1 (Cloudflare DNS) and then an internal AWS resolver. You can also specify a custom resolver
