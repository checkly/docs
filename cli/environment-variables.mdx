...
Global, Group or Check level](/docs/platform/variables). Here is what you need to remember:
...
3. For remote variables, store sensitive data as secrets in Checkly. For more information on how to manage secrets in Checkly see [variables and secrets](/docs/platform/variables).
