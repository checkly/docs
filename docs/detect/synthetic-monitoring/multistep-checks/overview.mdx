...
<Card title="Multistep Check Examples" href="/docs/detect/synthetic-monitoring/multistep-checks/examples">
Explore real-world workflow examples and patterns
</Card>

<Card title="Multistep Check Troubleshooting" href="/docs/detect/synthetic-monitoring/multistep-checks/troubleshooting">
