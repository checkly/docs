...
<Frame>
  <img src="/images/guides/global-monitoring/one-vantage-point.svg" alt="Diagram: a monitor in us-east-1 reports 100% uptime against a healthy origin, while users in Australia hit a failed CDN edge, users in Brazil a congested peering link, and users in Japan a stale DNS answer" />
</Frame>
